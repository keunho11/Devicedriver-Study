...
static void mkproc(void)
{
	...
	keyledproc_led_fp   = proc_create_data( "led", S_IFREG | S_IRWXU, keyledproc_root_fp, &proc_fops, NULL);
	keyledproc_key_fp   = proc_create_data( "key", S_IFREG | S_IRWXU, keyledproc_root_fp, &proc_fops, NULL);
}
